        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100  banner" src="img/IBIT/new leaflet.jpg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100 banner" src="img/IBIT/campus_font.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
                ...
                <!--<div class="carousel-item">-->
                <!--    <img class="w-100" src="img/IBIT/reunion.jpg" alt="Image">-->
                <!--    <div class="carousel-caption">-->
                <!--        <div class="container">-->
                <!--            <div class="row justify-content-center">-->
                                <!--<div class="col-lg-7">-->
                ...
                <!--</div>-->
                <!--<div class="carousel-item">-->
                <!--    <img class="w-100" src="img/IBIT/banner3.jpg" alt="Image">-->
                <!--    <div class="carousel-caption">-->
                <!--        <div class="container">-->
                <!--            <div class="row justify-content-center">-->
                <!--                <div class="col-lg-7">-->
                ...
                <!--</div>-->
                <!--<div class="carousel-item">-->
                <!--    <img class="w-100" src="img/Teachers/Aug2.jpg" alt="Image">-->
                <!--    <div class="carousel-caption">-->
                <!--        <div class="container">-->
                <!--            <div class="row justify-content-center">-->
                <!--                <div class="col-lg-7">-->
